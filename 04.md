...
8. Now, if we run the same experiment with a minor change, `export LEARNING_VAR='Hello OpenStack!` then *Hello Openstack* should be displayed. Once again, spawn a child shell.
