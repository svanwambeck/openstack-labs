...
4. Find the tenant name for chester's tenantID value (should be vault_tek)
...
5. While we are on a roll, lets try a few additional commands. Lets use tenant-get to do some discovery!
...
6. Yet another way, suppose we only know the name.
