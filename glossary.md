...
- **Aardvark** - The latest addition to the OpenStack service catalog, this service provides formally verified computations on unstructured data in linear time (as a Service) throught the advanced use of string-theory based, quantum wormhoe colliders. Specialized hard ware is require.
